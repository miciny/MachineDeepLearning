from IMDB.imdb_funcs import vec_sequence, draw_vec_loss, draw_vec_accuracy
import numpy as np
from IMDB.imdb_model import get_model
...
class IMDALearn():
    ...
    def set_data(self):
        ...
        print("==============加载数据中==============")
        (train_data, train_labels), (test_data, test_labels) = self.im_db.load_data(num_words=10000)
        print("==============加载数据完成==============")
        ...
        self.partial_x_train = x_train[10000:]
        self.y_val = y_train[:10000]
        self.partial_y_train = y_train[10000:]
        print("==============分离数据完成==============")
